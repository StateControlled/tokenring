...
object TokenRing extends App {
    ...
    private val concertHall     = new Venue("Orchestra Hall",   numberOfChunksPerEvent * 10)
    private val libertyStadium  = new Venue("Liberty Stadium",  numberOfChunksPerEvent * 10)
    private val greenField      = new Venue("Green Field",      numberOfChunksPerEvent * 10)
    private val outdoorStage    = new Venue("Outdoor Stage",    numberOfChunksPerEvent * 10)
